# Quickstart: M1 Durable Task Backbone
...
Expected: strict check/build pass; deterministic tests pass; each listed smoke emits a passed result and exits successfully. The checks use disposable fixtures. Unset M1_LIVE_OLLAMA or set it to 0 for fake-provider validation.
